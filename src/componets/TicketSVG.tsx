...
const TicketSVG: React.FC<Props> = ({ props }) => {
  ...
  return (
    <div className="w-full h-auto">
      ...
      >
        ...
        <image href={fileImg || ""} x="10" y="150" width="100" height="100" />
        <text x="120" y="190" fill="#fff" fontSize="26" fontWeight="bold">
          {props?.name}
        </text>
        <image
          href="/images/icon-github.svg"
          x="120"
          y="210"
          width="30"
          height="30"
